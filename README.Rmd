...
### R version
The basic function for searching in National Corpus of Polish is `ava_corpus`. This function creates a dataframe with a results from the corpus. The function `ava_corpus` have a lot of arguments (as in all R function, it is not obligatory to write names of the arguments):
